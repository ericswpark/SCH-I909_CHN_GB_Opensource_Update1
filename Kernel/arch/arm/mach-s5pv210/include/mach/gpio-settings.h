...
static unsigned int initial_gpio_table[][4] =
{
...
#else
	{S5PV210_GPA0(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // _3_TOUCH_SDA_28V
	{S5PV210_GPA0(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //_3_TOUCH_SCL_28V
#endif
	{S5PV210_GPA0(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_USB_SDA_28V
	{S5PV210_GPA0(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_USB_SCL_28V

	// GPB ---------------------------------------------------------------------
	{S5PV210_GPB(0),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPB(1),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPB(2),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
...
#else
	{S5PV210_GPB(6),  S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, 
#endif
	{S5PV210_GPB(7),  S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 

	// GPC0 --------------------------------------------------------------------
	{S5PV210_GPC0(0), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPC0(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//GPIO_CP_PCM_SEL
	{S5PV210_GPC0(2), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPC0(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC0(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPC1(4), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, //GPIO_MICBIAS_EN
	...
	{S5PV210_GPG0(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_ALS_SCL_28V
	...
	{S5PV210_GPG3(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
#if defined(CONFIG_MACH_S5PC110_LATONA)
...
#endif
	{S5PV210_GPG3(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	...
	{S5PV210_GPJ1(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_MIC_SEL
	...
	// GPJ2 --------------------------------------------------------------------
	{S5PV210_GPJ2(0), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ2(1), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ2(2), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 	
	{S5PV210_GPJ2(3), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ2(4), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ2(5), GPIO_MSMIF_AF, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ2(6), GPIO_MSMIF_AF, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ2(7), GPIO_MSMIF_AF, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 

	// GPJ3 --------------------------------------------------------------------
	{S5PV210_GPJ3(0), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(1), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(2), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(3), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(4), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(5), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(6), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ3(7), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 

	// GPJ4 --------------------------------------------------------------------
	{S5PV210_GPJ4(0), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ4(1), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ4(2), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ4(3), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPJ4(4), GPIO_MSMIF_AF,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
...
#else
	{S5PV210_MP03(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_NONE}, 
#endif
	...
	// MP04 --------------------------------------------------------------------
	{S5PV210_MP04(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//GPIO_MICBIAS_EN_OLD
...
//	{S5PV210_GPH0(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_PS_VOUT
	...
	{S5PV210_GPH2(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_GPH20
	{S5PV210_GPH2(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_KBC1
	...
	{S5PV210_GPH3(0), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_NONE,  S3C_GPIO_PULL_NONE},	//GPIO_KBR0
	{S5PV210_GPH3(3), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_NONE,  S3C_GPIO_PULL_NONE},	//GPIO_KBR3
	{S5PV210_GPH3(7), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_NONE,  S3C_GPIO_PULL_NONE},	//GPIO_CP_RST
};
