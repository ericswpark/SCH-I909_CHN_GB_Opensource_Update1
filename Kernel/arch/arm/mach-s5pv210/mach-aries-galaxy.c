...
#if !defined(CONFIG_MACH_S5PC110_GALAXY) //TEMP for compile
...
#endif
{
	...
	printk("%s , askonstatus = %d , who_is_the_caller_of_fsa9480=%d, attached=%d\n" , __func__ , askonstatus , who_is_the_caller_of_fsa9480, attached);
...
static unsigned int jupiter_sleep_gpio_table[][3] = 
{
	...
	{S5PV210_GPJ1(3), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE}, // to always turn on TSP 
	{S5PV210_GPJ1(4), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},
	{S5PV210_GPJ1(5), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},
...
#if 0//defined(CONFIG_MACH_S5PC110_ARIESCT)	//TSP init floating problem.
	qt_touch_init();
#endif
