...
void qt_Acquisition_Config_Init(void)
{
    ...
    acquisition_config.atchcalsthr = 45;
...
void qt_Multitouchscreen_stylus_Init(void)
{
    ...
    touchscreen_config.tchthr = 22;//16;	// 25;//45;	
...
void qt_Noise_Suppression_Config_Init(void)
{
	...
	noise_freq_table.freq_for_fherr4[1] = 24;
	noise_freq_table.freq_for_fherr4[2] = 30;
	noise_freq_table.freq_for_fherr4[3] = 40;
	noise_freq_table.freq_for_fherr4[4] = 48;
#endif
}
