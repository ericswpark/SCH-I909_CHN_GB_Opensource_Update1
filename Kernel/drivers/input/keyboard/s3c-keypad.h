...
#define FLIP_OPEN_KEYCODE	119
#define FLIP_CLOSE_KEYCODE	120
#define OK_KEYCODE			232
#define END_KEYCODE			62
#define END_APPS_KEYCODE	63

#define KEYPAD_COLUMNS		5
#define KEYPAD_ROWS			6
#define MAX_KEYPAD_NR		30
...
int keypad_keycode[] = {
		...
		5,		6,		7,		34, 	49, 	26,
		8,		9,		10, 	25, 	42, 	58,
		227,	11, 	228,	50, 	212,	210,
#else
	102,116,0,118,114,115,
#endif
};
...
#if defined (CONFIG_MACH_S5PC110_PRESTIGE)
int keypad_keycode_Rev05[] = {
#if 1
	61, 	14, 	59, 	118, 	0,		0,
	2,		3,		4,		105, 	108, 	0,
	5,		6,		7,		158, 	106, 	116,
	8,		9,		10, 	103, 	115, 	0,
	227,	11, 	228,	102, 	114, 	0,
#else
	61,		14,		59,		40,		0,		0,
	2,		3,		4,		57,		41,		0,
	5,		6,		7,		34,		49,		26,
