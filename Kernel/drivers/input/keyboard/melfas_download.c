...
//#include "MMH_SVESTA_R00_V02_bin.c"	// include bin file
//#include "MMH_W899_R09_V06_bin.c"
#include "MMH_W899_R09_V08_bin.c"
...
void get_touchkey_firmware6(char *version)
{

	_i2c_read_(TOUCHKEY_ADDRESS, version, 6);
	//printk("%s F/W version: 0x%x, Module version:0x%x\n",__FUNCTION__, version[1],version[2]);
}
