...
static void mDNIe_Set_Mode(Lcd_mDNIe_UI mode, u8 mDNIe_Outdoor_OnOff)
{
	...
	gprintk("[mDNIe] %s: current_mDNIe_UI(%d), current_mDNIe_OutDoor_OnOff(%d)\n", __func__, current_mDNIe_UI, current_mDNIe_OutDoor_OnOff);	
}
