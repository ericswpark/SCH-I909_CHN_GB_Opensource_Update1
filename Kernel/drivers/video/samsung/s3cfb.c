...
#if defined(CONFIG_ARIES_CTC_GALAXY)
...
#include <linux/gpio.h>
#include <plat/gpio-cfg.h>
#include "logo_rgb24_wvga_portrait-latona.h"
#elif defined(CONFIG_ARIES_CTC_PRESTIGE)
#include "logo_rgb24_wvga_portrait-prestige.h"
...
static int __devinit s3cfb_probe(struct platform_device *pdev)
{
	...
	s3cfb_set_window(fbdev, 0, 0);	//kk0704.park :: Disable 0th Window to protect LCD broken image
...
#if 0//defined(CONFIG_MACH_S5PC110_LATONA)
//lcd_reset low
