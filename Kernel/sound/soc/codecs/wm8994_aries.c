...
struct gain_info_t recording_gain_table[RECORDING_GAIN_NUM] = {
	{ /* MAIN */
		...
		.reg  = WM8994_LEFT_LINE_INPUT_1_2_VOLUME,	/* 18h */
		.mask = WM8994_IN1L_VOL_MASK,
		.gain = WM8994_IN1L_VU | 0x14		/* +19.5dB */
	}, {
		.mode = RECORDING_MAIN,
		.reg  = WM8994_INPUT_MIXER_3,		/* 29h */
		.mask = WM8994_IN1L_MIXINL_VOL_MASK | WM8994_MIXOUTL_MIXINL_VOL_MASK,
...
/* CHN soon9.lee -start */
		//Noise Gate
		wm8994_write( codec, WM8994_AIF1_DRC1_2, 0x0265);
		wm8994_write( codec, WM8994_AIF1_DRC1_3, 0x0C00);
		wm8994_write( codec, WM8994_AIF1_DRC1_4, 0x00A0);
		wm8994_write( codec, WM8994_AIF1_DRC1_5, 0x0004);
		wm8994_write( codec, WM8994_AIF1_DRC1_1, 0x0102);
/* CHN soon9.lee -end */
	} else {
		val = wm8994_read(codec, WM8994_AIF1_MASTER_SLAVE);
		val |= (WM8994_AIF1_MSTR | WM8994_AIF1_CLK_FRC | WM8994_AIF1_LRCLK_FRC);
