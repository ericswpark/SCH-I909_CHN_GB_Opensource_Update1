...
struct gain_info_t recording_gain_table[RECORDING_GAIN_NUM] = {
	{ /* MAIN */
		...
		.reg  = WM8994_LEFT_LINE_INPUT_1_2_VOLUME,	/* 18h */
		.mask = WM8994_IN1L_VOL_MASK,
		.gain = WM8994_IN1L_VU | 0x13		/* +19.5dB */
	}, {
		.mode = RECORDING_MAIN,
		.reg  = WM8994_INPUT_MIXER_3,		/* 29h */
		.mask = WM8994_IN1L_MIXINL_VOL_MASK | WM8994_MIXOUTL_MIXINL_VOL_MASK,
...
/* CHN soon9.lee -start */
	wm8994_write(codec,WM8994_AIF1_DRC1_2, 0x845);
	wm8994_write(codec,WM8994_AIF1_DRC1_3, 0x400);
	wm8994_write(codec,WM8994_AIF1_DRC1_4, 0x0);
	wm8994_write(codec,WM8994_AIF1_DRC1_5, 0x200);
	wm8994_write(codec,WM8994_AIF1_DRC1_1, 0x19C);
/* CHN soon9.lee -end */
...
void wm8994_set_fmradio_common(struct snd_soc_codec *codec)
{
	...
	wm8994_write(codec, WM8994_AIF2_DRC_2, 0x0841);
	wm8994_write(codec, WM8994_AIF2_DRC_3, 0x0400);
	wm8994_write(codec, WM8994_AIF2_DRC_4, 0x0201);
